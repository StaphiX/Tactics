...
public class FFacetRenderLayer : FRenderableLayerInterface
{
	...
	protected Vector2[] _uvs2 = new Vector2[0];
	...
	public void ExpandUV2()
	{
		Array.Resize(ref _uvs2, _uvs.Length);
		_didUVsChange = true;
	}
	...
	public void SetMaterialTex(string name, Texture tex)
	{
		if(_material != null)
		{
			_material.SetTexture(name, tex);
		}
	}
}
